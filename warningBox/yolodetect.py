...
class YoloDetect():
    def __init__(self, detect_class="person", frame_width=1280, frame_height=720):
        ...
        self.alert_telegram_each = 10  # seconds
    ...
    def alert(self, img):
        ...
        if (self.last_alert is None) or (
            ...
            cv2.imwrite("alert.jpg", cv2.resize(img, dsize=None, fx=0.2, fy=0.2))
            ...
            with open('log.csv', 'a', newline='') as csvfile:
                ...
                writer.writerow([img_pth, current_time])
